...
#if defined(__GNUC__) && !defined(__clang__) && defined(HUSE_SIMD)
...
inline void assemblysumx4(float arr1[4],float arr2[4],float res[4]) {
    asm(
        "movups %1, %%xmm0 \n\t"
        "addps %2, %%xmm0 \n\t"
        "movups %%xmm0,%0"
...
inline void assemblysubx4(float arr1[4],float arr2[4],float res[4]) {
    asm(
        "movups %1, %%xmm0 \n\t"
        "subps %2, %%xmm0 \n\t"
        "movups %%xmm0,%0"
...
inline void assemblymulx4(float arr1[4],float arr2[4],float res[4]) {
    asm(
        "movups %1, %%xmm0 \n\t"
        "mulps %2, %%xmm0 \n\t"
        "movups %%xmm0,%0"
...
inline void assemblydivx4(float arr1[4],float arr2[4],float res[4]) {
    asm(
        "movups %1, %%xmm0 \n\t"
        "divps %2, %%xmm0 \n\t"
        "movups %%xmm0,%0"
...
inline float assemblysquarelength(float arr1[4]) {
    float res;
    asm(
        "movups %1, %%xmm0 \n\t"
        "mulps %%xmm0, %%xmm0 \n\t"
...
inline void storex4(int* destino, const int coco[4]) {
 ...
 */
HINLINE vec2 vec2_add(vec2 vector_0, vec2 vector_1) {
    return (vec2){
 ...
 * @return The resulting vector.
 */
HINLINE vec2 vec2_sub(vec2 vector_0, vec2 vector_1) {
    return (vec2){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y};
}
 ...
 * @return The resulting vector.
 */
HINLINE vec2 vec2_mul(vec2 vector_0, vec2 vector_1) {
    return (vec2){
        vector_0.x * vector_1.x,
        vector_0.y * vector_1.y};
}
 ...
 * @return The resulting vector.
 */
HINLINE vec2 vec2_div(vec2 vector_0, vec2 vector_1) {
    return (vec2){
        vector_0.x / vector_1.x,
        vector_0.y / vector_1.y};
}
 ...
 */
HINLINE f32 vec2_distance(vec2 vector_0, vec2 vector_1) {
    vec2 d = (vec2){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y};
 ...
 * @return The resulting vector.
 */
HINLINE vec3 vec3_add(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x + vector_1.x,
        vector_0.y + vector_1.y,
 ...
 * @return The resulting vector.
 */
HINLINE vec3 vec3_sub(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y,
        vector_0.z - vector_1.z};
 ...
 * @return The resulting vector.
 */
HINLINE vec3 vec3_mul(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x * vector_1.x,
        vector_0.y * vector_1.y,
        vector_0.z * vector_1.z};
 ...
 */
HINLINE vec3 vec3_mul_scalar(vec3 vector_0, f32 scalar) {
    return (vec3){
        vector_0.x * scalar,
        vector_0.y * scalar,
        vector_0.z * scalar};
 ...
 * @return The resulting vector.
 */
HINLINE vec3 vec3_div(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x / vector_1.x,
        vector_0.y / vector_1.y,
        vector_0.z / vector_1.z
 ...
 */
HINLINE f32 vec3_dot(vec3 vector_0, vec3 vector_1) {
    f32 p = 0;
 ...
 */
HINLINE vec3 vec3_cross(vec3 vector_0, vec3 vector_1) {
    return (vec3){
 ...
 * @return True if within tolerance; otherwise false.
 */
HINLINE const b8 vec3_compare(vec3 vector_0, vec3 vector_1, f32 tolerance) {
    if (habs(vector_0.x - vector_1.x) > tolerance) {
        return false;
    }
 ...
 * @return The distance between vector_0 and vector_1.
 */
HINLINE f32 vec3_distance(vec3 vector_0, vec3 vector_1) {
    vec3 d = (vec3){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y,
        vector_0.z - vector_1.z
 ...
 */
HINLINE vec3 vec3_transform(vec3 v, mat4 m) {
    vec3 out;
 ...
 * @return The resulting vector.
 */
HINLINE vec4 vec4_add(vec4 vector_0, vec4 vector_1) {
    vec4 result;
    /*for (u64 i = 0; i < 4; i++) {
        result.elements[i] = vector_0.elements[i] + vector_1.elements[i];
    }*/
   //#ifdef defined(HUSE_SIMD)
   #ifdef HUSE_SIMD
   assemblysumx4(vector_0.elements,vector_1.elements,result.elements);
   return result;
   #else
 ...
 * @return The resulting vector.
 */
HINLINE vec4 vec4_sub(vec4 vector_0, vec4 vector_1) {
    vec4 result;
    /*for (u64 i = 0; i < 4; i++) {
        result.elements[i] = vector_0.elements[i] - vector_1.elements[i];
    }*/
    #ifdef HUSE_SIMD
   assemblysubx4(vector_0.elements,vector_1.elements,result.elements);
   return result;
   #else
    result.elements[0] = vector_0.elements[0] - vector_1.elements[0];
    result.elements[1] = vector_0.elements[1] - vector_1.elements[1];
 ...
 * @return The resulting vector.
 */
HINLINE vec4 vec4_mul(vec4 vector_0, vec4 vector_1) {
    vec4 result;
    #ifdef HUSE_SIMD
   assemblymulx4(vector_0.elements,vector_1.elements,result.elements);
   return result;
   #else
    /*for (u64 i = 0; i < 4; i++) {
        result.elements[i] = vector_0.elements[i] * vector_1.elements[i];
 ...
 * @return The resulting vector.
 */
HINLINE vec4 vec4_div(vec4 vector_0, vec4 vector_1) {
    vec4 result;
     #ifdef HUSE_SIMD
   assemblydivx4(vector_0.elements,vector_1.elements,result.elements);
   return result;
   #else
    /*for (u64 i = 0; i < 4; i++) {
        result.elements[i] = vector_0.elements[i] / vector_1.elements[i];
...
HINLINE f32 vec4_length_squared(vec4 vector) {
    ...
    return assemblysquarelength(vector.elements);
 ...
 * @return True if within tolerance; otherwise false.
 */
HINLINE const b8 vec4_compare(vec4 vector_0, vec4 vector_1, f32 tolerance) {
    if (habs(vector_0.x - vector_1.x) > tolerance) {
        return false;
    }
    ...
    if (habs(vector_0.w - vector_1.w) > tolerance) {
        return false;
    }
 ...
 */
HINLINE mat4 mat4_orthographic(f32 left, f32 right, f32 bottom, f32 top, f32 near_clip, f32 far_clip) {
    mat4 out_matrix = mat4_identity();
...
/**
  ...
  */
HINLINE quat quat_mul(quat q_0, quat q_1) {
    quat out_quaternion;
...
/**
  ...
  */
HINLINE f32 quat_dot(quat q_0, quat q_1) {
    return q_0.x * q_1.x +
           q_0.y * q_1.y +
           q_0.z * q_1.z +
           q_0.w * q_1.w;
...
/**
  ...
  */
HINLINE quat quat_slerp(quat q_0, quat q_1, f32 percentage) {
    quat out_quaternion;
